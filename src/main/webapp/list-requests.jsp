    ...
    <div class="space-y-4">
            ...
            <div class="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition">
                <div class="flex items-start justify-between mb-4">
                    <div class="flex items-center gap-3">
                        ...
                        <c:choose>
                            <c:when test="${request.consultation.statut == STATUT_CONSULTATION_ATTENTE}">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="font-semibold text-gray-900">Dr. ${request.consultation.medecinGeneraliste.nom} ${request.consultation.medecinGeneraliste.prenom}</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="flex justify-end gap-3">
                    <a href="viewExpertiseRequest?id=${request.id}"
        ...
        <c:if test="${empty expertiseRequests}">
            <div class="bg-white rounded-lg shadow-md p-12 text-center">
                ...
                <p class="text-gray-600">Il n'y a actuellement aucune demande d'expertise correspondant à vos critères.</p>
            </div>
        </c:if>
    </div>
</div>
